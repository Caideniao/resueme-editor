<template>
    <div>
        <header class="log-header"><span class="arrow" @click="goBack"></span><span>账号登录</span></header>
...
.log-form{
    ...
    .log-button{
        ...
        background-color: rgb(59, 180, 250);
        display: block;
        margin:30px auto;
        border-radius: 6px;
...
.sign-up{
    width: 340px;height: 48px;
    border:1px solid rgb(58, 186, 245);
    display: block;
    margin:30px auto;
    border-radius: 6px;
    text-align: center;line-height: 48px;color: rgb(64, 177, 252);
}
.message{
    text-align: center;
    transition: all 0.5s;
